...
test("favorite count", () => {
  render(<Navbar />);
  const count = screen.getAllByRole("favorite-count");
...
//       const count = await component.root.findByProps({ 'data-testid': 'count' });

//       act(() => {
//         useBeerStore.setState({ beers: testBeers });
//       });

//       expect(count.find().toBe(42);
//     });
//   });
